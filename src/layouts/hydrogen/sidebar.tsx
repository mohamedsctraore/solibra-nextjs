                    ...
                    {item?.dropdownItems ? (
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          isActive
                            ? 'before:top-2/5 text-red before:absolute before:-start-3 before:block before:h-4/5 before:w-1 before:rounded-ee-md before:rounded-se-md before:bg-red 2xl:before:-start-5'
